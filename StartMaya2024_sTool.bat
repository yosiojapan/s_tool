echo ---- Start Maya 2024 S_TOOL script ----
...
start "" "C:\Program Files\Autodesk\Maya2024\bin\maya.exe" -hideConsole
REM start "" "C:\Program Files\Autodesk\Maya2024\bin\maya.exe" -hideConsole -noAutoloadPlugins