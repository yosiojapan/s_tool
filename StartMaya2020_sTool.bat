echo ---- Start Maya 2020 S_TOOL script ----
...
start "" "C:\Program Files\Autodesk\Maya2020\bin\maya.exe" -hideConsole
REM start "" "C:\Program Files\Autodesk\Maya2020\bin\maya.exe" -hideConsole -noAutoloadPlugins