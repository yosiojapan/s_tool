echo ---- Start Maya 2025 S_TOOL script ----
...
start "" "C:\Program Files\Autodesk\Maya2025\bin\maya.exe" -hideConsole
REM start "" "C:\Program Files\Autodesk\Maya2025\bin\maya.exe" -hideConsole -noAutoloadPlugins